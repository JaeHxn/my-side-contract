...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "전월세(임대차) 계약서, 근로 계약서, 인테리어(도급) 계약서, 프리랜서 계약서를 지원합니다. TXT, PDF, 사진(JPG/PNG) 파일을 업로드하거나 텍스트를 직접 붙여넣어 분석할 수 있으며, 최대 20,000자까지 지원합니다.",
      },
    },
    {
      "@type": "Question",
...
const howToSchema = {
  ...
  step: [
    ...
    },
    {
      ...
      position: 2,
      name: "계약서 내용 입력",
      text: "계약서 전문 또는 특약 조항을 텍스트로 붙여넣거나 TXT·PDF·사진(JPG/PNG) 파일을 올립니다. 최대 20,000자까지 지원합니다.",
      url: `${siteUrl}/upload`,
    },
    {
      "@type": "HowToStep",
